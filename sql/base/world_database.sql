...
# Dumping structure for table world.character_banned
...
CREATE TABLE IF NOT EXISTS `creature_classlevelstats` (
  ...
  `basehp0` smallint(5) NOT NULL,
  `basehp1` smallint(5) NOT NULL,
  `basehp2` smallint(5) NOT NULL,
  `basehp3` smallint(5) unsigned NOT NULL DEFAULT '0',
  `basemana` smallint(5) NOT NULL,
  `basearmor` smallint(5) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
# Dumping structure for table world.creature_formation_data
DROP TABLE IF EXISTS `creature_formation_data`;
CREATE TABLE IF NOT EXISTS `creature_formation_data` (
...
# Dumping structure for table world.creature_groups
...
# Dumping structure for table world.creature_group_data
DROP TABLE IF EXISTS `creature_group_data`;
CREATE TABLE IF NOT EXISTS `creature_group_data` (
...
# Dumping structure for table world.creature_involvedrelation
...
# Dumping structure for table world.creature_linked_respawn
...
# Dumping structure for table world.creature_onkill_currency
DROP TABLE IF EXISTS `creature_onkill_currency`;
CREATE TABLE IF NOT EXISTS `creature_onkill_currency` (
...
# Dumping structure for table world.creature_questrelation
...
# Dumping structure for table world.creature_respawn
...
# Dumping structure for table world.ctdb_version
DROP TABLE IF EXISTS `ctdb_version`;
CREATE TABLE IF NOT EXISTS `ctdb_version` (
  `version` text,
  `date` date DEFAULT NULL,
  `changelog` longtext
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='CTDB  Notes';
...
# Dumping structure for table world.gameobject_questrelation
...
# Dumping structure for table world.gameobject_respawn
...
CREATE TABLE IF NOT EXISTS `game_event_creature` (
  ...
  `eventEntry` smallint(6) NOT NULL,
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `game_event_gameobject_quest` (
  `id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `quest` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `eventEntry` smallint(5) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `game_tele` (
  ...
  `name` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='CTDB Tele Command';
...
# Dumping structure for table world.instance
...
# Dumping structure for table world.instance_encounters
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='CTDB Item Random Enchantment System';
...
# Dumping structure for table world.item_set_names
...
# Dumping structure for table world.locales_creature
...
# Dumping structure for table world.locales_gameobject
...
# Dumping structure for table world.locales_item
...
# Dumping structure for table world.locales_npc_text
...
# Dumping structure for table world.locales_quest
...
# Dumping structure for table world.npc_trainer
...
CREATE TABLE IF NOT EXISTS `pet_name_generation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='CTDB Automatic pet name generation';
...
# Dumping structure for table world.pool_gameobject
...
# Dumping structure for table world.pool_pool
...
# Dumping structure for table world.pool_quest_save
...
# Dumping structure for table world.spelldifficulty_dbc
...
# Dumping structure for table world.spell_dbc
...
# Dumping structure for table world.spell_map
...
# Dumping structure for table world.spell_proc_event
...
# Dumping structure for table world.transport_template
...
# Dumping structure for table world.trillium_string
DROP TABLE IF EXISTS `trillium_string`;
CREATE TABLE IF NOT EXISTS `trillium_string` (
  `entry` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `content_default` text NOT NULL,
  `content_loc1` text,
  `content_loc2` text,
