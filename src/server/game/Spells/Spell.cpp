...
bool IsQuestTameSpell(uint32 spellId)
{
    ...
    return spellproto->GetSpellEffectIdByIndex(0) == SPELL_EFFECT_THREAT && spellproto->GetEffectApplyAuraNameByIndex(1) == SPELL_EFFECT_APPLY_AURA && spellproto->GetEffectApplyAuraNameByIndex(1) == SPELL_AURA_DUMMY;
}
