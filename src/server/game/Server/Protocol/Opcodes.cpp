...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                              \
    ...
    DEFINE_OPCODE_HANDLER( CMSG_QUEST_QUERY,                             STATUS_LOGGEDIN_OR_RECENTLY_LOGGOUT, PROCESS_INPLACE,        &WorldSession::HandleQuestQueryOpcode );
    DEFINE_OPCODE_HANDLER( SMSG_QUEST_QUERY_RESPONSE,                    STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_GAMEOBJECT_QUERY,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleGameObjectQueryOpcode     );
    DEFINE_OPCODE_HANDLER( SMSG_GAMEOBJECT_QUERY_RESPONSE,               STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_CREATURE_QUERY,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleCreatureQueryOpcode       );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_GROUP_CANCEL,                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_CHANNEL_MODERATE,                        STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_BACKWARD,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_STOP,                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_STRAFE_LEFT,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_STRAFE_RIGHT,                  STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_STOP_STRAFE,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_JUMP,                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_TURN_LEFT,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_TURN_RIGHT,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_STOP_TURN,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_PITCH_UP,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_PITCH_DOWN,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_STOP_PITCH,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_SET_RUN_MODE,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_SET_WALK_MODE,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER( MSG_MOVE_TELEPORT_ACK,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveTeleportAck           );
    ...
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_SWIM,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_STOP_SWIM,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER( MSG_MOVE_SET_FACING,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_SET_PITCH,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_RUN_SPEED_CHANGE_ACK,              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    DEFINE_OPCODE_HANDLER( SMSG_FORCE_RUN_BACK_SPEED_CHANGE,             STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK,         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_MOVE_ROOT_ACK,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveRootAck               );
    DEFINE_OPCODE_HANDLER( SMSG_FORCE_MOVE_UNROOT,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_MOVE_UNROOT_ACK,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveUnRootAck             );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_MOVE_KNOCK_BACK_ACK,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveKnockBackAck          );
    ...
    DEFINE_OPCODE_HANDLER( OBSOLETE_DROP_ITEM,                           STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_CAST_SPELL,                              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleCastSpellOpcode           );
    DEFINE_OPCODE_HANDLER( CMSG_CANCEL_CAST,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleCancelCastOpcode          );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_TAXISHOWNODES,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleTaxiQueryAvailableNodes   );
    DEFINE_OPCODE_HANDLER( SMSG_SHOWTAXINODES,                           STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide                  );
    DEFINE_OPCODE_HANDLER( CMSG_TAXINODE_STATUS_QUERY,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleTaxiNodeStatusQueryOpcode );
    DEFINE_OPCODE_HANDLER( SMSG_TAXINODE_STATUS,                         STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_TAXIQUERYAVAILABLENODES,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleTaxiQueryAvailableNodes   );
    DEFINE_OPCODE_HANDLER( CMSG_ACTIVATETAXI,                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleActivateTaxiOpcode        );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_SETSHEATHED,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleSetSheathedOpcode         );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_AUTH_SESSION,                            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_EarlyProccess            );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_QUEST_FORCE_REMOVED,                     STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_GUILD_SET_NOTE,                          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_BATTLEFIELD_JOIN,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleBattlemasterJoinOpcode    );
    DEFINE_OPCODE_HANDLER( CMSG_REQUEST_RATED_BG_INFO,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( CMSG_REQUEST_PVP_OPTIONS_ENABLED,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_STANDSTATE_CHANGE_FAILURE_OBSOLETE,      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_STABLE_CHANGE_SLOT,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_GROUP_SWAP_SUB_GROUP,                    STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_SET_SAVED_INSTANCE_EXTEND,               STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( SMSG_LFG_OFFER_CONTINUE,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_MEETINGSTONE_CHEAT,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( SMSG_MEETINGSTONE_SETQUEUE,                   STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_MEETINGSTONE_INFO,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMeetingStoneInfo          );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_GMTICKETSYSTEM_TOGGLE,                   STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( MSG_MOVE_TOGGLE_GRAVITY_CHEAT,                STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_MOVE_FALL_RESET,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_MOVE_TIME_SKIPPED,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveTimeSkippedOpcode     );
    DEFINE_OPCODE_HANDLER( CMSG_MOVE_FEATHER_FALL_ACK,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleFeatherFallAck            );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_WALK_SPEED_CHANGE_ACK,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_BATTLEFIELD_REQUEST_SCORE_DATA,          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandlePVPLogDataOpcode          );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_BATTLEGROUND_PLAYER_POSITIONS,           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleBattlegroundPlayerPositionsOpcode);
    ...
    DEFINE_OPCODE_HANDLER( CMSG_ACTIVATETAXIEXPRESS,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleActivateTaxiExpressOpcode );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_MOVE_SET_FLIGHT,                         STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( SMSG_MOVE_UNSET_FLIGHT,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_MOVE_FLIGHT_ACK,                         STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_ASCEND,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER( MSG_MOVE_STOP_ASCEND,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_LFG_SET_NEEDS,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK,           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    DEFINE_OPCODE_HANDLER( SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE,          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK,      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_MOVE_CHNG_TRANSPORT,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_TIME_SYNC_RESP,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleTimeSyncResp              );
    ...
    DEFINE_OPCODE_HANDLER( MSG_MOVE_START_DESCEND,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_GET_MIRRORIMAGE_DATA,                    STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_KEEP_ALIVE,                              STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_EarlyProccess            );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_ACCEPT_LEVEL_GRANT,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_MOVE_ABANDON_TRANSPORT,                  STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( SMSG_CALENDAR_UPDATE_INVITE_LIST,             STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( SMSG_CALENDAR_UPDATE_INVITE_LIST2,            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_CALENDAR_UPDATE_INVITE_LIST3,            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_REQUEST_PLAYER_VEHICLE_EXIT,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleRequestVehicleExit        );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_ENABLETAXI,                              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleTaxiQueryAvailableNodes   );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_LFG_SET_ROLES_2,                         STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_FORCE_UNK1_SPEED_CHANGE,                 STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_UNK1_SPEED_CHANGE_ACK,             STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( SMSG_FORCE_UNK2_SPEED_CHANGE,                 STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_FORCE_UNK2_SPEED_CHANGE_ACK,             STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( SMSG_MOVE_LEVITATING,                         STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( SMSG_SPLINE_MOVE_UNKNOWN_1235,                STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( SMSG_SPLINE_MOVE_UNKNOWN_1236,                STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_UNKNOWN_1240,                            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_WORLD_STATE_UI_TIMER_UPDATE,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleWorldStateUITimerUpdate   );
    ...
    DEFINE_OPCODE_HANDLER( SMSG_UNKNOWN_1276,                            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_UNKNOWN_1303,                            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( SMSG_UNKNOWN_1304,                            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( SMSG_SEND_QUEUED_PACKETS,                     STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_REDIRECT_AUTH_PROOF,                     STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_VIOLENCE_LEVEL,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleViolenceLevelOpcode       );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_REQUEST_CATEGORY_COOLDOWNS,              STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER( CMSG_CUF_PROFILES_SAVE,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( SMSG_CUF_PROFILES_LOAD,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
