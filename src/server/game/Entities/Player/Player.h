...
// 2^n values, Player::m_isunderwater is a bitmask. These are Trillium internal values, they are never send to any client
...
enum TransferAbortReason // 4.20a 14480
{
    ...
    TRANSFER_ABORT_LOCKED_TO_DIFFERENT_INSTANCE = 0x12,
    TRANSFER_ABORT_ALREADY_COMPLETED_ENCOUNTER  = 0x13,
};
