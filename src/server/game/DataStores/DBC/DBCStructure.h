...
struct ItemLimitCategoryEntry
{
    ...
    uint32      mode;                                       // 3, 0 = have, 1 = equip (enum ItemLimitCategoryMode)= equip (enum ItemLimitCategoryMode)
};
...
struct SoundEntriesEntry
{
    ...
    //DBCString FileName[10];                               // 3-12     m_File[10]    m_File[10]
