...
const char ItemSparsefmt[]="niiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiixxxxxxxxxxxxxxxxxxxxiiifiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiisxxxsiiiiiiiiiiiiiiiiiiiiiiifiiifxx";
