                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_NATURE_BOMB:
                        {
                            ...
                            Trillium::AnyPlayerInObjectRangeCheck checker(me, 50.0f);
                            Trillium::PlayerListSearcher<Trillium::AnyPlayerInObjectRangeCheck> searcher(me, PlayerList, checker);
...
class npc_healthy_spore : public CreatureScript
{
    public:
        ...
        struct npc_healthy_sporeAI : public Scripted_NoMovementAI
        {
            ...
            {
                std::list<Player*> PlayerList;
                Trillium::AnyPlayerInObjectRangeCheck checker(me, 6.0f);
                Trillium::PlayerListSearcher<Trillium::AnyPlayerInObjectRangeCheck> searcher(me, PlayerList, checker);
        ...
        class spell_freya_attuned_to_nature_SpellScript : public SpellScript
        {
            ...
            void ModAuraStack()
            {
                if (Aura* aura = GetHitAura())
                    aura->SetStackAmount(uint8(GetSpellInfo()->GetStackAmount()));
            }
