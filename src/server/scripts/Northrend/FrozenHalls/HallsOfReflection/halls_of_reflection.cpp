...
class achievement_retreat : public AchievementCriteriaScript
{
    public:
        achievement_retreat() : AchievementCriteriaScript("achievement_retreat")
        {
        }
        ...
        bool OnCheck(Player* /*player*/, Unit* target)
        {
            ...
            if (Creature* Lich = target->ToCreature())
                if (Lich->AI()->GetData(DATA_RETREAT))
                    return true;
