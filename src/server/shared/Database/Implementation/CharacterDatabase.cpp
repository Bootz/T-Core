...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    "health, power1, power2, power3, power4, power5, instance_id, speccount, activespec, exploredZones, equipmentCache, knownTitles, achievementPoints, actionBars, currentPetSlot, petSlotUsed, grantableLevels FROM characters WHERE guid = ?", CONNECTION_ASYNC)
    ...
    PREPARE_STATEMENT(CHAR_LOAD_PLAYER_TALENTBRANCHSPECS, "SELECT talentBranchSpec, talentSpec FROM character_talentbranchspec WHERE guid = ?", CONNECTION_ASYNC)
